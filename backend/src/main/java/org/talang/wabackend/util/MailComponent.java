...
public class MailComponent {
    ...
    public static final String FORGET_MAIL_PREFIX = "mail:forget:";
    ...
    public boolean sendForgetMail(String to) {
        log.info("MailComponent.sendForgetMail: " + to);

        String key = FORGET_MAIL_PREFIX + to;
        ...
        sendMail(to, "忘记密码验证码","您的验证码为" + code + "，请在5分钟内完成验证");
